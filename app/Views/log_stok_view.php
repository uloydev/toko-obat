...
<div class="col-lg-6 col-7">
    <h6 class="h2 text-white d-inline-block mb-0">Log Stok</h6>
</div>
<?= $this->endSection() ?>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header border-0">
                <h3 class="mb-0">Tabel Log Stok Obat</h3>
            </div>
            <!-- Light table -->
                ...
                <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" class="sort" data-sort="jumlahLama">Jumlah Lama</th>
                            <th scope="col" class="sort" data-sort="jumlahBaru">Jumlah Baru</th>
                    ...
                    <tbody class="list">
                        <tr v-for="item in items" :key="item.id_obat">
                            ...
                            <td>{{ item.jumlah_lama }}</td>
                            <td>{{ item.jumlah_baru }}</td>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            // Delete Product
            destroyLog: function () {
                axios.delete(`/log/deletestokobat/${this.logId}`)
                .then(res => {
                    // handle success
                    this.getLog();
                    this.toggleModal(this.modalDelete);
